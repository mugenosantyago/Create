...
public final class CreateHauntingRecipeGen extends HauntingRecipeGen {
	...
	SOUL_SAND = convert(() -> com.simibubi.create.foundation.utility.NbtCompat.ingredientFromTag(ItemTags.SAND), () -> Blocks.SOUL_SAND),
	SOUL_DIRT = convert(() -> com.simibubi.create.foundation.utility.NbtCompat.ingredientFromTag(ItemTags.DIRT), () -> Blocks.SOUL_SOIL),
		BLACK_STONE = convert(() -> com.simibubi.create.foundation.utility.NbtCompat.ingredientFromTag(Tags.Items.COBBLESTONES), () -> Blocks.BLACKSTONE),
