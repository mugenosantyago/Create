...
public class SchematicTableScreen extends AbstractSimiContainerScreen<SchematicTableMenu> {
	...
	protected void renderBg(GuiGraphics graphics, float partialTicks, int mouseX, int mouseY) {
		...
		graphics.blit(net.minecraft.client.renderer.RenderPipelines.GUI_TEXTURED, SCHEMATIC_TABLE_PROGRESS.location, x + 70, y + 59, (float)(SCHEMATIC_TABLE_PROGRESS.getStartX()), (float)(SCHEMATIC_TABLE_PROGRESS.getStartY()), width, height, 256, 256);
	}
